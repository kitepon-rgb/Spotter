...
> v1.5.2 / v1.5.3公開時点の証拠。現在の端末online状態やinstall versionを表す台帳ではない。
...
- case詳細: request、当時auditorへ渡したcontext、当時のThroughline observer snapshot、提案ID、利用ID、item結果を別欄で表示
